...
ActiveRecord::Schema.define(version: 2021_05_19_113523) do
  ...
  create_view "top_scorers", materialized: true, sql_definition: <<-SQL
  ...
  SQL
  add_index "top_scorers", ["player_id"], name: "index_top_scorers_on_player_id"
  add_index "top_scorers", ["player_name"], name: "index_top_scorers_on_player_name"
  add_index "top_scorers", ["season"], name: "index_top_scorers_on_season"
  add_index "top_scorers", ["team_id"], name: "index_top_scorers_on_team_id"
  add_index "top_scorers", ["team_name"], name: "index_top_scorers_on_team_name"
